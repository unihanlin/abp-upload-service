...
using Unihanlin.AbpUploadService.MultiTenancy;
...
public class AbpUploadServiceAuthServerModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("AbpUploadService");
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddAbpSwaggerGenWithOAuth(
            ...
            {
                {"AbpUploadService", "AbpUploadService API"}
            },
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "AbpUploadService API", Version = "v1" });
        ...
        {
            options.KeyPrefix = "AbpUploadService:";
        });

        var dataProtectionBuilder = context.Services.AddDataProtection().SetApplicationName("AbpUploadService");
        if (!hostingEnvironment.IsDevelopment())
        {
            var redis = ConnectionMultiplexer.Connect(configuration["Redis:Configuration"]);
            dataProtectionBuilder.PersistKeysToStackExchangeRedis(redis, "AbpUploadService-Protection-Keys");
        }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "AbpUploadService API");
