...
namespace Unihanlin.AbpUploadService.Data;

public class AbpUploadServiceTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<AbpUploadServiceTenantDatabaseMigrationHandler> _logger;

    public AbpUploadServiceTenantDatabaseMigrationHandler(
        IDbContextProvider<AuthServerHostMigrationsDbContext> dbContextProvider,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<AbpUploadServiceTenantDatabaseMigrationHandler> logger)
    {
